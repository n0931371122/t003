        ...
        <div id="cases" class="overflow-hidden">
            ...
            <div class="banner-section">
                ...
                <div class="fw-600 text-white absolute-center text-center w-100 px-4 pb-5">
                    <span class="d-block fz-160 lh-115" data-aos="fade-up">PROJECTS</span>
                    <span class="d-block NotoSerifTC fz-24 les2" data-aos="fade-up" data-aos-delay="100">服務案例</span>
                </div>
                <button class="mouse position-absolute" type="button">
                    <img src="styles/images/common/mouse.svg" alt="">
                </button>
            </div>
            <div class="position-relative bg-white pt-5 py-lg-5 px-lg-4">
                <div class="pb-lg-5">
                    <span class="d-block fz-28 fw-bold text-uppercase text-center text-black pt-xl-5 pb-xl-2">overview</span>
                    <div class="max1295 mx-auto pt-4 pt-md-5 py-lg-5 mt-xl-4 mb-lg-5">
                        <div class="item">
                            ...
                            <a class="d-block d-lg-flex row g-0" href="/projects-1">
                                ...
                                <span class="col-lg-6 d-block z-1 pe-lg-4">
                                    <span class="img-inner d-block overflow-hidden pe-lg-3" data-aos="fade-right">
                                        <img class="object-fit" src="styles/images/cases/1.jpg" alt="">
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="item">
                            ...
                            <a class="d-block d-lg-flex row g-0" href="/projects-2">
                                ...
                                <span class="col-lg-6 d-block z-1 ps-lg-4">
                                    <span class="img-inner d-block overflow-hidden ps-lg-3" data-aos="fade-left">
                                        <img class="object-fit" src="styles/images/cases/2.jpg" alt="">
                                    </span>
                                </span>
                            </a>
                        </div>
